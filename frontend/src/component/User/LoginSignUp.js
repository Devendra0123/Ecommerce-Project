...
import {clearError,login, register} from "../../redux/User/userSlice";
...
function LoginSignUp({ history, location }) {
  ...
  const [avatar, setAvatar] = useState("./ProfileImage.jpg");
                  ...
                  <div className="LoginSignUpContainer">
                    <div className="LoginSignUpBox">
                      ...
                      <form className="loginForm" ref={loginTab} onSubmit={loginSubmit}>
                        ...
                        <Link style={{fontSize:"10px"}} to="/password/forgot">Forget Password ?</Link>
